...
| 6 | Limite reservations atteinte (3 max) | Limite max de 3 reservations parametree + adherent connecte ayant deja 3 reservations actives | Depuis une fiche livre reservable, cliquer Reserver une 4e fois | Reservation refusee, message explicite indique que la limite de 3 reservations est atteinte, aucune nouvelle reservation n est creee | Adherent |
...
| 14 | Limite emprunts atteinte (5 max) | Limite max de 5 emprunts parametree + biblio connecte + membre ayant deja 5 emprunts actifs | Ouvrir /librarian/loan, selectionner le membre puis un livre disponible, valider un 6e emprunt | Emprunt refuse, message explicite indique que la limite de 5 emprunts est atteinte, aucun emprunt n est cree et le livre reste disponible | Biblio |
